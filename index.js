...
function addProductToCart(title, price, productImg){
    ...
    for (var i = 0; i< cartItemsNames.length; i++){
        if (cartItemsNames[i].innerText == title){
            alert('Añadiste este item al carrito');
            return;
        }
    }
...
function updateTotal(){
    ...
    // En caso que el resultado del total este escrito en decimal
...
// mantener el articulo en el carrito cuando la pagina se actualiza con LocalStorage
...
// Icon de cantidad en el carrito
